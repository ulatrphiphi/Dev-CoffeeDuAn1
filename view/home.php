...
<section class="home-slider owl-carousel">
    ...
    <section class="ftco-about d-md-flex">
      <div
        class="one-half img"
        style="background-image: url(/view/images/about.jpg)"
      ></div>
              ...
              <div class="col-md-6">
                <div class="menu-entry">
                  <a
                    href="#"
                    class="img"
                    style="background-image: url(/view/images/menu-1.jpg)"
                  ></a>
                </div>
              </div>
              <div class="col-md-6">
                <div class="menu-entry mt-lg-4">
                  <a
                    href="#"
                    class="img"
                    style="background-image: url(/view/images/menu-2.jpg)"
                  ></a>
                </div>
              </div>
              <div class="col-md-6">
                <div class="menu-entry">
                  <a
                    href="#"
                    class="img"
                    style="background-image: url(/view/images/menu-3.jpg)"
                  ></a>
                </div>
              </div>
              <div class="col-md-6">
                <div class="menu-entry mt-lg-4">
                  <a
                    href="#"
                    class="img"
                    style="background-image: url(/view/images/menu-4.jpg)"
                  ></a>
                </div>
              </div>
            </div>
    ...
    <section
      ...
      id="section-counter"
      style="background-image: url(/view/images/bg_2.jpg)"
        ...
        <div class="row no-gutters">
          <div class="col-md-3 ftco-animate">
            <a
              ...
              style="background-image: url(/view/images/gallery-1.jpg)"
            >
              <div
          ...
          <div class="col-md-3 ftco-animate">
            <a
              href="gallery.html"
              class="gallery img d-flex align-items-center"
              style="background-image: url(/view/images/gallery-2.jpg)"
            >
              <div
                class="icon mb-4 d-flex align-items-center justify-content-center"
              >
          ...
          <div class="col-md-3 ftco-animate">
            <a
              href="gallery.html"
              class="gallery img d-flex align-items-center"
              style="background-image: url(/view/images/gallery-3.jpg)"
            >
              <div
                class="icon mb-4 d-flex align-items-center justify-content-center"
              >
          ...
          <div class="col-md-3 ftco-animate">
            <a
              href="gallery.html"
              class="gallery img d-flex align-items-center"
              style="background-image: url(/view/images/gallery-4.jpg)"
            >
              <div
                class="icon mb-4 d-flex align-items-center justify-content-center"
              >
    ...
    <section
      ...
      id="ftco-testimony"
      style="background-image: url(/view/images/bg_1.jpg)"
      data-stellar-background-ratio="0.5"
    >
      <div class="overlay"></div>
      <div class="container">
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a
                href="blog-single.html"
                class="block-20"
                style="background-image: url('/view/images/image_3.jpg')"
              >
              </a>
              <div class="text py-4 d-block">
                <div class="meta">
