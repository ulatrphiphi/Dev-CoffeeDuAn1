...
<section class="ftco-about d-md-flex">
  <div class="one-half img" style="background-image: url(/view/images/about.jpg)"></div>
    ...
    <div class="row align-items-center">
      <div class="col-md-6 pr-md-5">
        <div class="heading-section text-md-right ftco-animate">
          ...
          <p class="mb-4">
            Menu của quán bao gồm nhiều loại đồ uống cà phê, trà, đồ ăn nhẹ,...
            được pha chế từ nguyên liệu tươi ngon, chất lượng.
            Chúng tôi luôn nỗ lực mang đến cho khách hàng những trải nghiệm ẩm thực tuyệt vời nhất.
          </p>
          <p>
            <a href="#" class="btn btn-primary btn-outline-primary px-4 py-3">Xem Menu</a>
          </p>
        </div>
      </div>
      <div class="col-md-6">
...
<section class="ftco-counter ftco-bg-dark img" id="section-counter" style="background-image: url(/view/images/bg_2.jpg)" data-stellar-background-ratio="0.5">
  <div class="overlay"></div>
  <div class="container">
...
<section class="ftco-section img" id="ftco-testimony" style="background-image: url(/view/images/bg_1.jpg)" data-stellar-background-ratio="0.5">
  ...
  <div class="container">
    <div class="row justify-content-center mb-5">
      <div class="col-md-7 heading-section text-center ftco-animate">
        <span class="subheading">Nhận Xét</span><br>
        <h2 class="mb-4">Của Khách Hàng</h2>
      </div>
    </div>
  </div>
  <div class="container-wrap">
...
Đồ uống cũng khá ok, chưa đậm vị lắm.&rdquo;
      ...
      <div class="col-lg align-self-sm-end ftco-animate">
        <div class="testimony">
          <blockquote>
            <p>
              &ldquo;Dev Coffee Cần Thơ là một quán mới khai trương ở Cần Thơ. Quán là một chuỗi thương hiệu khá nổi tiếng. Không gian quán có phong cách rất sáng và rộng rãi. Thích hợp cho tụ họp bạn bè, ngồi trầm cafe làm việc,... Bảng giá mình có chụp trong hình ảnh nha! &rdquo;
            </p>
          </blockquote>
          <div class="author d-flex mt-4">
            <div class="image mr-3 align-self-center">
      ...
      <div class="col-lg align-self-sm-end">
        <div class="testimony overlay">
          <blockquote>
            <p>
              &ldquo;Không gian thoải mái với đồ uống phục vụ tương đối nhanh, nhân viên thân thiện.&rdquo;
            </p>
          </blockquote>
          <div class="author d-flex mt-4">
            <div class="image mr-3 align-self-center">
